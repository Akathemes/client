...
const Data = () => {
  return (
    <div className='home__data'>
       <h1 className='home__title'>Reliable<br/><span className='color-change'>& Honest.</span>
       {/* <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
       ...
       <p className='home__description'> I'm creative developer, currently living in Germany. And I'm very passionate and dedicated to my work</p>
